...
def setup_editable_install():
    ...
    try:
        ...
        test_result = subprocess.run([
            sys.executable, '-c', 
            'import phaze; from phaze.phaze import main; print("✅ Import test successful")'
...
def main():
    ...
    if not setup_editable_install():
        ...
        print(f"   echo '{Path(__file__).parent.absolute()}' > {get_site_packages()}/__phaze_editable__.pth")
        sys.exit(1)
