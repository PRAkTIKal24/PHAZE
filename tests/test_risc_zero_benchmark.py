...
class TestRiscZeroComprehensiveBenchmark:
    ...
    def setup_method(self):
        ...
        self.suite.zkml_benchmark.rust_manager.backends["risc_zero"] = RustRiscZeroBackend()
    ...
    async def test_risc_zero_only_benchmark(self):
        ...
        custom_suite.zkml_benchmark.rust_manager.backends["risc_zero"] = RustRiscZeroBackend()
