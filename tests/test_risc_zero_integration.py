...
from phaze.src.zkml_framework_interface import ZKMLFramework, ZKMLBackendInterface
from phaze.src.zkml_backends import RiscZeroBackend, create_backend
...
@pytest.mark.skip(reason="Full RISC Zero integration requires actual RISC Zero dependency")
@pytest.mark.asyncio
