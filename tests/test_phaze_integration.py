...
class TestPHAZEIntegration:
    ...
    def test_model_factory_workflow(self):
        ...
        simple_model = PHAZEModelFactory.create_early_exit_model(
            "simple", complexity=ModelComplexity.LIGHT, input_size=20, output_size=10
        )
        ...
        assert simple_model.complexity in [
    ...
    def test_convenience_functions(self):
        ...
        # Test simple early exit model
        early_model = create_simple_early_exit_model(input_size=15, output_size=5)
        assert early_model.input_size == 15
        assert early_model.output_size == 5

        # Test simple full model
        full_model = create_simple_full_model(input_size=15, output_size=5)
    ...
    async def test_benchmark_workflow(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            results = await run_phaze_benchmarks(output_dir=temp_dir, quick_mode=True)
    ...
    def test_model_complexity_levels(self):
        ...
        for complexity in complexities:
            model = PHAZEModelFactory.create_early_exit_model(
                "simple", complexity=complexity, input_size=10, output_size=5
            )
    ...
    def test_model_serialization_compatibility(self):
        ...
        model = create_simple_early_exit_model(input_size=10, output_size=5)
...
class TestPHAZEPerformance:
    ...
    def test_model_inference_speed(self):
        ...
        model = create_simple_early_exit_model(input_size=100, output_size=10)
        model.eval()
