...
class StatisticalUtils:
    ...
    def calculate_error_bars(
        ...
        for series in data:
            ...
            if error_type == "std":
                ...
                _, lower, upper = StatisticalUtils.calculate_confidence_interval(series, 0.95)
    ...
    def filter_outliers(
        ...
        return [val for val, is_outlier in zip(data, outliers) if not is_outlier]
    ...
    def aggregate_trials(
        ...
        for metric_name, values in trial_results.items():
            ...
            if aggregation == "mean":
                ...
                central_value = np.median(filtered_values) if filtered_values else np.median(values_array)
            else:
