...
from .model_architectures import SimpleEarlyExitModel as _SimpleEarlyExitModel
...
def create_early_exit_model(
    architecture: str = "simple", complexity: str = "light", **kwargs
):
...
def create_multi_exit_model(
    input_size: int = 10, output_size: int = 5, complexity: str = "medium"
):
    """Create a multi-exit model."""
    return create_early_exit_model(
        "multi_exit", complexity, input_size=input_size, output_size=output_size
    )


def create_transformer_model(
    input_size: int = 512, output_size: int = 10, complexity: str = "medium"
):
    """Create a transformer-based early-exit model."""
    return create_early_exit_model(
        "transformer", complexity, input_size=input_size, output_size=output_size
    )
